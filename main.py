...
def insert_voters(conn,cur,voter):
    cur.execute(
        """
            INSERT INTO voters(voter_id,voter_name,date_of_birth,
            gender,nationality,registration_number,address_street,
            address_city,address_state,address_country,address_postcode,
...
if __name__=='__main__':
    try:
        conn = psycopg2.connect("host=localhost dbname=voting user=postgres password=devi")
        cur =  conn.cursor()
